...
<html>
	...
	<body>
		...
		<div id="show-item" class="content scaffold-show" role="main">
            <h1><g:message code="default.show.label" args="[entityName]" />   <g:helpBalloon code="item.label"/></h1>
			...
			<ol class="property-list item">
                ...
                <g:if test="${itemInstance?.tipo}">
                    <li class="fieldcontain">
                        <span id="tipo-label" class="property-label"><g:message code="item.tipo.label" default="Tipo" /></span>

                        <span class="property-value" aria-labelledby="tipo-label"><g:fieldValue bean="${itemInstance}" field="tipo"/></span>
